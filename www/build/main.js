    ...
    ProfilePage.prototype.navigateToCharity = function (charityName) {
        switch (charityName) {
            case 'Schistosomiasis Control Initiative':
                ...
                this.description = "The Schistosomiasis Control Initiative (SCI), at Imperial College London, is a non-profit initiative that works with Ministries of Health in sub-Saharan African countries and Yemen. It supports and evaluates treatment programmes against schistosomiasis and soil-transmitted helminthiasis.";
                this.logourl = "https://yt3.ggpht.com/a-/AJLlDp0IwdEtAAhi271YFTwwAZJycfUD1h6FNQtGzw=s900-mo-c-c0xffffffff-rj-k-no";
                this.siteurl = "https://www.imperial.ac.uk/schistosomiasis-control-initiative";
                break;
            case 'Against Malaria Foundation':
                this.name = "Against Malaria Foundation";
                this.description = "The Against Malaria Foundation (AMF) is a United Kingdom-based charity that provides long-lasting insecticidal nets (LLINs) to populations at high risk of malaria, primarily in Africa.";
                ...
                this.siteurl = "https://www.againstmalaria.com/";
                break;
        }
